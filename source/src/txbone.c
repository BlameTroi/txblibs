...
one_block *
keys(one_block *ob) { return make_one(alist);}
one_block *
values(one_block *ob) { return make_one(alist);}
...
one_block *
add_with_priority(one_block *ob, long pri, void *payload) {return NULL;}

one_block *
add_with_max(one_block *ob, void *payload) {return NULL;}

one_block *
add_with_min(one_block *ob, void *payload) {return NULL;}

long
max_priority(one_block *ob) {return 0;}

long
min_priority(one_block *ob) {return 0;}

bool
get_max(one_block *ob, long *pri, void *payload) {return NULL;}

bool
get_min(one_block *ob, long *pri, void *payload) {return NULL;}

bool
peek_max(one_block *ob, long *pri, void *payload) {return NULL;}

bool
peek_min(one_block *ob, long *pri, void *payload) {return NULL;}
